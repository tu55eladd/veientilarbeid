...
import { loggVisningGammel } from '../../metrics/metrics';
...
const WrappedViewport: React.ComponentType<Props> = handleViewport(InViewportGammel);

function InViewportGammel(props: Props & ViewportProps): JSX.Element {
    ...
    function loggTilAmplitude() {
        if (harVistTilBruker) {
            loggVisningGammel({ viser: props.loggTekst, ...amplitudeData });
        }
    }
